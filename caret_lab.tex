...
\CommentTok{\# Use createDataPartition to split the data into training and validation sets}
...
\CommentTok{\# Create the training set}
\NormalTok{train\_data }\OtherTok{\textless{}{-}}\NormalTok{ dataset[index, ]}

\CommentTok{\# Create the validation set}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Separate input (x) and output (y)}
...
\CommentTok{\# Display the first few rows of x and y}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Make predictions using the LDA model}
